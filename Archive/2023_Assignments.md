...
*keywords:* Five schools of Open Science, International context,  The Open Science conversation (NL, UU, Physics), Laboratory life, The reproducibility crisis, Fraud, Access and emancipation, Community-Discipline-Employer, Transdisciplinary and interdisciplinary science, Risks and rewards of Open Science, Opposition and counterarguments
 [Lecture](Lectures/Week1/Lecture1.md)
...
*keywords:* Version control, Licensing and receiving credit, Readme files and templates, Best practices for community management, Issue management and Getting Things Done (GTD), Unit testing (defensive programming), Merging forked repositories 
 ...
 [Lecture](Lectures/Week2/Lecture2.md)
 
### Assignments and exercises:
+ **Collaborative coding:** (MAJOR exercise) In two or more big teams, students have to fork a poorly-documented python project that needs troubleshooting, assign the project elements to subgroups and coordinate inter-operability and unified documentation.
...
To prepare for the next exercise, watch the recorded lectures of dr. Niels Martens on [Introduction to big science collaborations](https://www.youtube.com/watch?v=M1giIxeLuIg) and [Credit and authorship](https://www.youtube.com/watch?v=DRt1uTytWf8).

Form teams to investigate one of the big scientific collaboration; [see list here](Lectures/Week3/Lecture3.md#list-of-projects-to-investigate).  Each teams will investigate the collaboration structure assigned to them and report back in week 3 according to [these guidelines](Lectures/Week3/bigcollab_report_MAKECOPY.md).
...
*keywords:* Big-science collaborations, Citizen science, Credit and recognition, Policy and politics of science, Governance structures, Independence and thriving, Big science vs big network, Climate impacts and transformation of the research ecosystem.
 [Lecture](Lectures/Week3/Lecture3.md)
 
### Assignments and exercises:
+ **Big-science organization structure:** (MAJOR exercise) Students will, in groups of 4-8, investigate the structure, history, function, and working conditions of a big collaborations and present for the class. Presentations will receive peer-feedback.
...
*keywords:* Best practices for documentation, Data structures and data plans, templates and bug reports, Persistent identifiers, Machine-readable docs, Systematic review, Scripting, Compatibility, Dockers-Virtual Environments-Pinning, Best practices in data visualization, 
 [Lecture](Lectures/Week4/Lecture4.md)
 
### Assignments and exercises:
+ **Reproducible measurement project:** (MAJOR exercise) Student teams start with their measurement projects according to [these requirements](Lectures/Week4/Lecture4.md#project-minimal-requirements), define the goal and the processes, and create the documentation folder by following the tips in the lecture and in the [readme template](Lectures/Week2/README_template.md).
...
[Lecture](Lectures/Week5/Lecture5.md)
 
### Assignments and exercises:
+ **Project bazaar:** Each team presents their project to the class
+ **Reproducibility report:**  (MAJOR exercise) Teams reproduce each-others project and write a project peer-review using the [peer evaluation template](Lectures/Week5/peer_evaluation_FORWHICHPROJECT.md)
...
*keywords:* Storytelling, Science communication and journalism, Activism and trust in Science, Bounds of expertise, Academic social contract, Metaphors, Communicating uncertainty, Narratives and framing, Difficult to reach audience, Process and outcome
 [Lecture](Lectures/Week6/Lecture6.md)
 
### Assignments and exercises:
+ **Lay-person summary:**  (MAJOR exercise) Each student writes a lay person summary of one of their previous or future projects
...
*keywords:* Technology transfer, Open strategies and open science business models, Scipreneurship; starting a business, Creating impact, Forking vs contributing, Moral ambition, IP-Licensing-Conflict of interest
 [Lecture](Lectures/Week7/Lecture7.md)
 
### Assignments and exercises:
+ **Open canvas:**  (MAJOR exercise) Students individually make an open (business) canvas about the potential users of the master thesis topic or a project
...
[Lecture](Lectures/Week8/Lecture8.md)
 
### Assignments and exercises:
+ **Storytelling**:  (MAJOR exercise) In groups of 2-4^, make a video pitch about an open science concept, whether you support or disagree. Show and tell all pitches. 
