...
-  09:00-9:30: [Lecture](https://git.science.uu.nl/os4p-2023/os4p23/-/blob/main/Lectures/Week6/Lecture06_ScientistsRole.pdf?ref_type=heads) by Erik van Sebille on
   - Academic social contract
   - Trust in science
   - Bounds of expertise
   - Activism
...
- 09:45-10:45: [Guest lecture](https://git.science.uu.nl/os4p-2023/os4p23/-/blob/main/Lectures/Week6/Lecture06_ScienceCommunication_JuliaCramer.pptx?ref_type=heads) by [Dr Julia Cramer (Leiden University)](https://www.universiteitleiden.nl/en/staffmembers/julia-cramer#tab-1) on
...
- 12:30-12:45 OAC Interim Evaluation of the course (without lecturers)
...
**Assignment submission**: Students submit a comment to [this Issue](https://git.science.uu.nl/os4p-2023/os4p23/-/issues/28) with their original abstract, their original layperson summary, the feedback they received from their peers, their revised layperson summary, and the output from the language-check tool.

**Assignment grading**: The students receive a pass if they submit a layperson summary that passes the language-check tool. To pass, the text has to have an [Automated Readibility Index](https://en.wikipedia.org/wiki/Automated_readability_index) of less than 13.0 (i.e. be undertandable for 18-year-olds).
